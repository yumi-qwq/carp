...
public final class Settings {
    ...
    /**
     * When a pathing process fails to calculate a path, instead of just giving up, mark the closest instance
     * of that block as "unreachable" and go towards the next closest. Some processes expand this search to the whole "vein".
     */
    ...
    /**
     * When a pathing process doesn't know any locations for the desired block, explore randomly instead of giving up.
     */
    ...
    /**
     * Allow standing above a block while mining it.
     * <p>
     * Experimental
     */

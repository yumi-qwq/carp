...
public class ConfigGui extends GuiConfigsBase {
    ...
    public void initGui() {
        ...
        for (int i = 0; i < n; i++) {
            ...
            final int ti = i;
            this.addButton(b, (bb, mb) -> Minecraft.getInstance().setScreenAndShow(new ConfigGui(prev, ti)));
        }
    }
    ...
    public static void open() { Minecraft.getInstance().setScreenAndShow(new ConfigGui()); }
    public static void open(Screen p) { Minecraft.getInstance().setScreenAndShow(new ConfigGui(p)); }
}
